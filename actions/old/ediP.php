...
function sendMail($numEmail=""){
    ...
    */
    ...
    $mail->AddAttachment("../edi_files/edi/posicion.edi","posicion.edi");
    ...
    */
    ...
    unlink("../edi_files/csv/posicion.csv");
    //unlink("../edi_files/edi/entradas.edi");
    unlink("../edi_files/edi/posicion.edi");      
...
function getEdiMSC($deli,$ori,$des){        
    ...
    if ( is_uploaded_file($HTTP_POST_FILES['userfile']['tmp_name']) ) {
        copy($HTTP_POST_FILES['userfile']['tmp_name'], "../edi_files/csv/posicion.csv");
    }
    else {
    ...
    unset($data);
    unset($dataX);
    $fp = fopen("../edi_files/csv/posicion.csv","r");
    $validFile="True";
    ...
    if( $validFile=="True" ){                    
        ...
        $fileEDI = "../edi_files/edi/posicion.edi";
        $fp2 = fopen("$fileEDI","w");
        $sepa="\n";                
